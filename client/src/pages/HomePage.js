...
function SubMenu(){
    return(
        <div class="container-fluid  bg-dark" >
            <nav class="d-flex justify-content-center  py-0">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a href="#" class="nav-link text-white" aria-current="page">For Sales </a></li>
                    <li class="nav-item"><a href="#" class="nav-link text-white">Trade in</a></li>
                    <li class="nav-item"><a href="#" class="nav-link text-white">Jobs</a></li>
                    <li class="nav-item "><a href="#" class="nav-link text-white">Housing</a></li>
                    <li class="nav-item"><a href="#" class="nav-link text-white">Forums</a></li>
                </ul>
            </nav>
        </div>
    );
